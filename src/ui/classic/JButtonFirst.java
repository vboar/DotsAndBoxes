 ...
 * 经典模式玩家是否先手设置玩家先手
 */
public class JButtonFirst extends JPanel implements MouseListener {

	private JFrameGame jFrameGame;
	private JPanelClassic jPanelClassic ;
	private Image img = ImgClassic.check;
	
	public JButtonFirst(JFrameGame jFrameGame, JPanelClassic jPanelClassic ) {
		this.jFrameGame = jFrameGame;
		this.jPanelClassic = jPanelClassic;
		this.setOpaque(false);
		this.setBounds(360, 396, 32, 25);
	...
	public void mouseClicked(MouseEvent e) {
		if (Controller.getController().getNumOfAI() > 0) {
			...
			Controller.getController().setPlayerFirst(true);
		} else {
