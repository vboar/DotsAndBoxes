 ...
 * 经典模式难度级别设置hard类
 */
public class JButtonHard extends JPanel implements MouseListener {

	private JFrameGame jFrameGame;
	private JPanelClassic jPanelClassic ;
	private Image img = ImgClassic.check;
	
	public JButtonHard(JFrameGame jFrameGame, JPanelClassic jPanelClassic ) {
		this.jFrameGame = jFrameGame;
		this.jPanelClassic = jPanelClassic;
		this.setOpaque(false);
		this.setBounds(525, 326, 32, 25);
	...
	public void paint(Graphics g) {
		super.paint(g);
		if (Controller.getController().getDifficulty() == 4)
